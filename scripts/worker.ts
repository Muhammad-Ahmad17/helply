 ...
 * Polls claim_crawl_jobs every POLL_INTERVAL_MS — no HTTP cron required.
 *
 * Run: npm run worker
 * Requires: SUPABASE_SERVICE_ROLE_KEY, JINA_API_KEY
 */
import { claimAndProcessJobs } from "../src/lib/crawl-worker";
